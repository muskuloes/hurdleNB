...
test_that("Dd works for vector y at level 2", {
  ...
  expect_equal(round(oo$Dth2[zind, 3], 5), D0th2th2)
  ...
  expect_equal(round(oo$Dmuth2[zind, 3], 5), D0muth2th2)
  ...
  expect_equal(round(oo$Dmu2th2[zind, 3], 5), D0mu2th2th2)
  ...
  expect_equal(round(oo$Dth2[!zind, 3], 5), Dth2th2)
  ...
  expect_equal(round(oo$Dmuth2[!zind, 3], 5), Dmuth2th2)
  ...
  expect_equal(round(oo$Dmu2th2[!zind, 3], 5), Dmu2th2th2)
  ...
  # dθ₁dθ₀, dθ₂dθ₀.
  expect_equal(oo$Dth2[, 4], rep(0, n))
  expect_equal(oo$Dth2[, 5], rep(0, n))
  expect_equal(oo$Dmuth2[, 4], rep(0, n))
  expect_equal(oo$Dmuth2[, 5], rep(0, n))
  expect_equal(oo$Dmu2th2[, 4], rep(0, n))
